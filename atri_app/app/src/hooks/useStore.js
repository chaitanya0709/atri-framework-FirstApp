...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "Image27": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/6087cab3a74dfa369ea2e92a_Group%2084%20(1).svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "UnorderedList8": {
      "custom": {
        ...
        "items": [
          {
            "title": "4353 Delaware Avenue, San Francisco, USA",
            "description": " hi@thefolio.com"
          }
        ]
      },
      "callbacks": {
